  ...
  Indicator: {
    main: css`
      ...
      box-shadow: inset 0 0 0 2px
        ${props => (props.color ? colors[props.color] || props.color : colors.gray[4])};
      transition: ${transition.all};

      input:active + & {
        box-shadow: inset 0 0 0 2px
          ${props => (props.color ? colors[props.color] || props.color : colors.shades.secondary[4])};
      }

      input:checked + & {
        box-shadow: inset 0 0 0 8px
          ${props => (props.color ? colors[props.color] || props.color : colors.accent)};
      }
